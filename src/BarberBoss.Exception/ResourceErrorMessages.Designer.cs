...
namespace BarberBoss.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The billing can&apos;t be for the future!.
        /// </summary>
        public static string BILLING_CANT_BE_FOR_THE_FUTURE {
            get {
                return ResourceManager.GetString("BILLING_CANT_BE_FOR_THE_FUTURE", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string THE_AMOUNT_MUST_BE_GREATHER_THAN_ZERO {
            get {
                return ResourceManager.GetString("THE_AMOUNT_MUST_BE_GREATHER_THAN_ZERO", resourceCulture);
            }
        }
